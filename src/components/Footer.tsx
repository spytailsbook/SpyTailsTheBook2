export default function Footer() {
  return (
    <footer
      id="contact"
      className="border-t border-accent-amber/30 px-6 py-6 md:h-16 flex flex-col md:flex-row items-center justify-between z-10 bg-tertiary-dark relative gap-4 rounded-none"
    >
